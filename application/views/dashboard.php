  ...
  <html>
    ...
    <body id="home" class="scrollspy">
        ...
        <ul class="slides">
          <!-- <li>
            ...
            <div class="caption center-align">
              <h3>Selamat Datang di Kelurahan Jepon</h3>
              <h5 class="light grey-text text-lighten-3">KECAMATAN JEPON - KABUPATEN BLORA</h5>
            </div>
          </li>  -->
           <li>
            <img src="<?php echo base_url('assets') ?>/user/img/slider/kantor.png"> <!-- random image -->
            <div class="caption center-align">
              <h3>Selamat Datang di Kelurahan Jepon</h3>
              <h5 class="light grey-text text-lighten-3">KECAMATAN JEPON - KABUPATEN BLORA</h5>
            </div>
      ...
      <footer class="yellow darken-3 white-text center">
        <p style="font-size: 15px;" class="flow-text">copyright &copy; Kelurahan Jepon | Web Profil <?php echo date('Y'); ?></p>
      </footer>
