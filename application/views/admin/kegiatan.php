                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a title="Delete Pesan" href="<?php echo base_url('admin/kegiatan/delete/'.$row->id_kegiatan); ?>" class="btn btn-sm btn-danger" onclick="return confirm('Yakin Akan dihapus?');">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h3 class="modal-title">Form Tambah Data Kegiatan</h3>
      </div>
      <div class="modal-body">
        <form method="post" action="<?php echo base_url('admin/kegiatan/add'); ?>">
